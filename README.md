...
| `OPSSLATE_WEBUI_URL` | `http://localhost:8099` | Optional Unraid Docker WebUI label URL. Set this in `.env` to your server's LAN URL, for example `http://192.168.0.42:8099`. |
